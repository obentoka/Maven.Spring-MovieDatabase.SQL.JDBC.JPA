...
public class JdbcPersonServiceImpl implements PersonService{
    ...
    public Person updatePerson(Long id, Person newPersonData){
        if(findPersonById(id) != null) {
            ...
            jdbcTemplate.update(sql, newPersonData.getLastName(), newPersonData.getFirstName(), newPersonData.getMobile(),
                    newPersonData.getBirthday(), newPersonData.getHomeId(), id);
